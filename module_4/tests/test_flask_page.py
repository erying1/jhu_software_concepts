...
def test_analysis_page_has_buttons(client):
    ...
    assert 'Pull Data' in html or 'pull-data' in html.lower() or 'pull_data' in html.lower()
    
    # Check for "Update Analysis" button
    assert 'Update Analysis' in html or 'update-analysis' in html.lower() or 'update_analysis' in html.lower()
